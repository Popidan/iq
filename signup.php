        ...
        if($Valabil){
            if($Admin){
                ...
                if($Cod == 123){
                    ...
                    $conn->query($sql);
                    header("Location: http://localhost/iqweb-main/iqweb-main/Iqweb/content.php?User='$Nume'");
                    ...
                    header("Location: http://localhost/iqweb-main/iqweb-main/Iqweb/signup_view.php?er=2");
                    //exit();
                ...
                $sql = "INSERT INTO users (nume, email, parola, confirm, admin) VALUES ('$Nume', '$Email', '$Parola', 0, '$Adm')";
                $conn->query($sql);
                header("Location: http://localhost/iqweb-main/iqweb-main/Iqweb/content.php");
            }
        }
        else{
            header("Location: http://localhost/iqweb-main/iqweb-main/Iqweb/signup_view.php?er=1");
            //exit();
        }
    }
    else {
        //in acest caz anuntam faptul ca un field nu este completat
        header("Location: http://localhost/iqweb-main/iqweb-main/Iqweb/signup_view.php?er=3");
    }
