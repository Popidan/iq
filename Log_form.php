...
if(!empty($nume) && !empty($parola)){
    ...
    if ($res->num_rows > 0) {
        ...
        if($parola == $row["Parola"]){
            ...
            $_SESSION["er"] = 1;
            header("Location: http://localhost/iqweb-main/iqweb-main/Iqweb/login.php?er=1");
        ...
        $_SESSION["er"] = 2;
        header("Location: http://localhost/iqweb-main/iqweb-main/Iqweb/login.php?er=2");
    }
    mysqli_close($conn);
        ...
        $_SESSION["er"] = 3;
        header("Location: http://localhost/iqweb-main/iqweb-main/Iqweb/login.php?er=3");
        exit();
}
